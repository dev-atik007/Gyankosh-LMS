...
@section('instructor')
    <div class="page-content">
        ...
        <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
            ...
            <div class="ms-auto">
                <div class="btn-group">
                    <a href="{{ route('instructor.all.coupon') }}" class="btn btn-primary px-5">All Coupon</a>
                </div>
            </div>
        </div>
        <!--end breadcrumb-->
            ...
            <div class="col-xl-12 mx-auto">
                <div class="card">
                    <div class="card-body p-4">
                        ...
                        <form action="{{ route('instructor.update.coupon') }}" method="POST" id="myForm"
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" name="coupon_name" class="form-control" value="{{ $coupon->coupon_name }}" id="catName">
                                <span class="category text-danger"></span>
                            </div>

                            <div class="form-group col-md-6">
                                <label for="input1" class="form-label">Coupon Discount </label>
                                <input type="text" name="coupon_discount" class="form-control" value="{{ $coupon->	coupon_discount	 }}" id="catName">
                                <span class="category text-danger"></span>
                            </div>
