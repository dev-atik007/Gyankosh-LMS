        ...
        <nav class="navbar navbar-expand gap-3">
                ...
                <ul class="navbar-nav align-items-center gap-1">
                    ...
                    <li class="nav-item dropdown dropdown-large">
                        <a class="nav-link dropdown-toggle dropdown-toggle-nocaret position-relative" href="#"
                            data-bs-toggle="dropdown"><span class="alert-count" id="notification-count">{{ $notiCount }}</span>
                                    ...
                                    <a class="dropdown-item" href="javascript:;" onclick="markNotificationRead('{{ $Notification->id }}')">
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div class="flex-grow-1">
                                                ...
                                                <p class="msg-info">New Ordedr</p>
                                            </div>
                                        </div>
                                    </a>
                                @empty
                                    <div class="flex-grow-1">
                                        <h6 class="msg-name">Data Not Found</h6>
                                    </div>
                                @endforelse
            ...
            <div class="user-box dropdown px-3">
                <a class="d-flex align-items-center nav-link dropdown-toggle gap-3 dropdown-toggle-nocaret"
                    ...
                    <img src="{{ !empty($instructorData->image) ? url('application/public/application/public/upload/instructor_images/' . @$instructorData->image) : url('application/public/application/public/upload/no_image.jpg') }}"
                ...
                <ul class="dropdown-menu dropdown-menu-end">
                    ...
                    <li><a class="dropdown-item d-flex align-items-center"
                            href="{{ route('instructor.password') }}"><i
