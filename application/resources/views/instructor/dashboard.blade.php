...
@section('instructor')
    ...
    @if ($status === '1')
        <h4>{{ $instructorId->name }} your Account Is <span class="text-success">Active</span></h4>
    @else
        <h4>{{ $instructorId->name }} Your Account Is <span class="text-danger">InActive</span></h4>
