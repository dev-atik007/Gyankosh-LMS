        ...
        <table width="100%" style="background: #F7F7F7; padding:0 20px 0 20px;">
            <tr>
                <td valign="top">
                    ...
                    <h2 style="color: green; font-size: 26px;"><strong>Gyankosh</strong></h2>
                </td>
                <td align="right">
                    <pre class="font">
               Gyankosh Head Office
               Email:gyankosh@easylearningbd.com <br>
               Mob: 1245454545 <br>
        ...
        <table width="100%">
            ...
            <tbody>
                ...
                @foreach ($order as $item)
                    <tr class="font">
                        <td align="center">
                            <img src="{{ public_path('application/public/uploads/course/thambnail/' . $item->course->course_image) }}" height="60px;" width="60px;" alt="">
                        </td>
