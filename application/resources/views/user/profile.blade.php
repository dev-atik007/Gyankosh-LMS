            ...
            <form action="{{ route('user.profile.update') }}" method="post" enctype="multipart/form-data" class="row pt-40px">
                ...
                <div class="media media-card align-items-center">
                    <div class="media-img media-img-lg mr-4 bg-gray">
                        <img class="mr-3" src="{{ (!empty($userData->image)) ? url('application/public/application/public/upload/user_images/' . $userData->image) : url('application/public/application/public/upload/no_image.jpg') }}" alt="avatar image">
                    </div>
                    <div class="media-body">
