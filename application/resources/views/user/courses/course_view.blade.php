@include('user.courses.body.header')
                                                    ...
                                                    <ul class="curriculum-sidebar-list">
                                                        ...
                                                        <li class="course-item-link">
                                                            <div class="course-item-content-wrap">
                                                                ...
                                                                <div class="course-item-content">
                                                                    <h4 class="fs-15">2. A simple concept to get ahead
                                                                    </h4>
                                                                    <div class="courser-item-meta-wrap">
                                                                        <p class="course-item-meta"><i
                                                                                class="la la-play-circle"></i>2min</p>
                                                    ...
                                                    <ul class="curriculum-sidebar-list">
                                                        ...
                                                        <li class="course-item-link">
                                                            <div class="course-item-content-wrap">
                                                                ...
                                                                <div class="course-item-content">
                                                                    <h4 class="fs-15">6. A simple concept to get ahead
                                                                    </h4>
                                                                    <div class="courser-item-meta-wrap">
                                                                        <p class="course-item-meta"><i
                                                                                class="la la-play-circle"></i>2min</p>
                                ...
                                <div class="lecture-overview-wrap">
                                    ...
                                    <div class="lecture-overview-item">
                                        <div class="lecture-overview-stats-wrap d-flex">
                                            ...
                                            <div class="lecture-overview-stats-item">
                                                <ul class="generic-list-item">
                                                    <li><span>Resources:</span>{{ $course->course->resource }}</li>
                                                    <li><span>Video length:</span>{{ $course->course->duration }} total
                                                        hours</li>
                                ...
                                <div class="lecture-overview-wrap lecture-announcement-wrap">
                                    <div class="lecture-overview-item">
                                        ...
                                        <div class="lecture-owner-decription pt-4">
                                            ...
                                            <p>The whole lot. In my course After Effects Complete Course packed with all
                                                Techniques and Methods (No Tricks and gimmicks).</p>
                                            <p class="font-italic"><strong>Unfortunately this will result in delayed
                                                    responses by me in the Q&A section and to direct messages. This is
                                                    only for the next week and once back I will be back to 100%
                                                    .</strong></p>
                                            <p>I will continue to do my best to respond to as many questions as possible
                                                but only one person, regularly I spend 4-5 hours daily on this and with
                                                over 440000 students as you can image that its a lot of work.</p>
                                            <p class="font-italic">Thank you once again for your understanding and for
                                                all of the wonderful students who I have had an opportunity to
                                            ...
                                            <div class="comments pt-40px">
                                                <div
                                                    ...
                                                    <div class="media-body">
                                                        ...
                                                        <p class="pt-1">Occaecati cupiditate non provident, similique
                                                            sunt in culpa fuga.</p>
                                                    </div><!-- end media-body -->
                                                </div><!-- end media -->
                                                <div
                                                    class="media media-card mb-3 border-bottom border-bottom-gray pb-3">
                        ...
                        <div class="row">
                            <div class="col-lg-3 responsive-column-half">
                                <div class="footer-item">
                                    <a href="index.html">
                                        <img src="{{ asset('application/public/templates/assets/images/logo.png') }}"
                                ...
                                <div class="footer-item">
                                    ...
                                    <div class="mobile-app">
                                        ...
                                        <a href="#" class="d-block mb-2 hover-s"><img
                                                src="{{ asset('application/public/templates/assets/images/appstore.png') }}"
...
@include('user.courses.body.footer')
