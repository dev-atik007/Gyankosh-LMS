<div class="off-canvas-menu dashboard-off-canvas-menu off--canvas-menu custom-scrollbar-styled pt-20px">
    ...
    <div class="logo-box px-4">
        <a href="{{ route('dashboard') }}" class="logo"><img
                src="{{ asset('application/public/templates/assets/images/logo.png') }}" alt="logo"></a>
    </div>
    <ul class="generic-list-item off-canvas-menu-list off--canvas-menu-list pt-35px">
        <li class="page-active"><a href="{{ route('dashboard') }}"><svg class="mr-2"
        ...
        <li class="page-active"><a href="{{ route('user.password') }}"><svg class="mr-2"
                    xmlns="http://www.w3.org/2000/svg" height="18px" viewBox="0 0 24 24" width="18px">
                    <path d="M0 0h24v24H0V0z" fill="none" />
                    <path
                        d="M12 17c-1.66 0-3-1.34-3-3 0-1.3.84-2.4 2-2.82V9c0-1.1.9-2 2-2s2 .9 2 2v2.18c1.16.42 2 1.52 2 2.82 0 1.66-1.34 3-3 3zm1-3h-2v-2h2v2zm-1-10c-4.42 0-8 3.58-8 8v6h16v-6c0-4.42-3.58-8-8-8z"
                        fill="white" />
