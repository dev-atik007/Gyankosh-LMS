...
@section('master')
    ...
    @section('title')
        {{ $course->subcategory->subcategory }} | Gyankosh Learning
    @endsection
        ...
        <div class="col-lg-8 mr-auto">
            <div class="breadcrumb-content">
                <ul class="generic-list-item generic-list-item-arrow d-flex flex-wrap align-items-center">
                    ...
                    <li><a href="#">{{ $course->category->category }}</a></li>
                    <li><a href="#">{{ $course->subcategory->subcategory }}</a></li>
                </ul>
                ...
                <div class="d-flex flex-wrap align-items-center">
                    <p class="pr-3 d-flex align-items-center">
                        ...
                        Last updated
                        {{ @$course->created_at != null ? @$course->created_at->format('M d Y') : @$course->updated_at->format('M d Y') }}
                    </p>
                    <p class="pr-3 d-flex align-items-center">
                        <svg class="svg-icon-color-gray mr-1" width="16px" viewBox="0 0 24 24">
                            <path
            ...
            <div class="col-lg-8 pb-5">
                <div class="course-details-content-wrap pt-90px">
                    ...
                    <div class="course-overview-card border border-gray p-4 rounded">
                        ...
                        <div class="pb-3">
                            <img width="85" class="mr-3"
                                src="{{ asset('application/public/templates/assets/images/sponsor-img.png') }}"
                                alt="company logo">
                            <img width="80" class="mr-3"
                                src="{{ asset('application/public/templates/assets/images/sponsor-img2.png') }}"
                                alt="company logo">
                            <img width="80" class="mr-3"
                                src="{{ asset('application/public/templates/assets/images/sponsor-img3.png') }}"
                                alt="company logo">
                            <img width="70" class="mr-3"
                                src="{{ asset('application/public/templates/assets/images/sponsor-img4.png') }}"
                                alt="company logo">
                    ...
                    <div class="course-overview-card">
                        ...
                        @php
                            $section = App\Models\CourseSection::where('course_id', $course->id)->get();
                        @endphp
                            ...
                            <div class="media media-card">
                                <div class="instructor-img">
                                    <a href="teacher-detail.html" class="media-img d-block">
                                        <img class="lazy"
                                            src="{{ !empty($course->user->image) ? url('application/public/application/public/upload/instructor_images/' . @$course->user->image) : url('application/public/application/public/upload/no_image.jpg') }}"
                                            alt="Avatar image">
                                    </a>
                            ...
                            <div class="media media-card align-items-center">
                                ...
                                <div class="media-body">
                                    @php
                                        ...
                                        $reviewBars = App\Models\Review::where('course_id', $course->id)
                                            ->where('status', 1)
                                        ...
                                        $totalReview = $reviewBars->sum('count');

                                        $percentages = [];

                                        for ($i = 5; $i >= 1; $i--) {
                                            $ratingCount = $reviewBars->where('rating', $i)->first();
                                ...
                                <div class="media media-card border-bottom border-bottom-gray pb-4 mb-4">
                                    <div class="media-img mr-4 rounded-full">
                                        <img class="rounded-full lazy"
                                            src="{{ !empty($item->user->image) ? url('application/public/application/public/upload/user_images/' . $item->user->image) : url('application/public/application/public/upload/no_image.jpg') }}"
                        ...
                        <div class="card-body">
                            <div class="preview-course-video">
                                <a href="javascript:void(0)" data-toggle="modal" data-target="#previewModal">
                                    <img src="images/img-loading.png" data-src="{{ asset($course->course_image) }}"
                                ...
                                <div class="preview-course-incentives">
                                    ...
                                    <ul class="generic-list-item pb-3">
                                        <li><i class="la la-play-circle-o mr-2 text-color"></i>{{ $course->duration }}
                                            hours on-demand
                                            video</li>
                                        <li><i class="la la-file mr-2 text-color"></i>{{ $course->resource }} articles
                                        </li>
                                ...
                                <div class="media media-card border-bottom border-bottom-gray pb-4 mb-4">
                                    ...
                                    <div class="media-body">
                                        ...
                                        @if ($related->discount_price == null)
                                            <span
                                                class="text-black font-weight-semi-bold lh-18 fs-15">${{ $related->selling_price }}</span>
                                        @else
                                            <span
                                                class="text-black font-weight-semi-bold lh-18 fs-15">${{ $related->discount_price }}</span>
                                            <span class="before-price fs-14">${{ $related->selling_price }}</span>
                                        @endif
                ...
                <div class="copy-to-clipboard">
                    ...
                    <div class="input-group">
                        <input type="text" class="form-control form--control copy-input pl-3"
                            value="http://localhost/gyankosh/{{ Request::path() }}">
                        <div class="input-group-append">
