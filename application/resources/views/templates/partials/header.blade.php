                    ...
                    <div class="header-widget">
                        <ul class="generic-list-item d-flex flex-wrap align-items-center fs-14">
                            <li class="d-flex align-items-center pr-3 mr-3 border-right border-right-gray"><i
                                    class="la la-phone mr-1"></i><a href="tel:00123456789"> {{ $settings->phone }}</a></li>
                            <li class="d-flex align-items-center"><i class="la la-envelope-o mr-1"></i><a
                                    href="mailto:contact@aduca.com"> {{ $settings->email }}</a></li>
                        </ul>
                        ...
                        <ul
                            ...
                            @auth
                                <li class="d-flex align-items-center pr-3 mr-3 border-right border-right-gray">
                                    <i class="la la-dashboard mr-1"></i>
        ...
        <div class="container-fluid">
            <div class="main-menu-content">
                ...
                <div class="row align-items-center">
                    <div class="col-lg-2">
                        <div class="logo-box">
                            <a href="{{ route('templates') }}" class="logo"><img
                    ...
                    @php
                        $categories = App\Models\Category::orderBy('category', 'ASC')->get();
                    @endphp
                    ...
                    <div class="col-lg-10">
                        <div class="menu-wrapper">
                                    ...
                                    <li>
                                        ...
                                        <ul class="cat-dropdown-menu">
                                            @foreach ($categories as $category)
                                                ...
                                                <li>
                                                    <a href="{{ url('category/' . $category->id . '/' . $category->slug) }}">{{ $category->category }}<i
                                                            class="la la-angle-right"></i></a>
                                                    <ul class="sub-menu">
                                                        @foreach ($subcategory as $subcat)
                                                            <li><a href="{{ url('subcategory/' . $subcat->id . '/' . $subcat->slug) }}">{{ $subcat->subcategory }}</a></li>
                                                        @endforeach
                            ...
                            <div class="shop-cart mr-4">
                                <ul>
                                    <li>
                                        <p class="shop-cart-btn d-flex align-items-center addToCartCount">
                                        ...
                                        <ul class="cart-dropdown-menu">
                                            ...
                                            <li>
                                                <a href="{{ route('cart.page') }}" class="btn theme-btn w-100">Go to cart
