      ...
      <div class="col-lg-3 responsive-column-half">
        <div class="footer-item">
          <a href="{{ route('templates') }}">
            <img src="{{ asset($settings->logo) }}" alt="footer logo" class="footer__logo">
          </a>
          ...
          <ul class="social-icons social-icons-styled">
            <li class="mr-1"><a href="{{ $settings->facebook }}" class="facebook-bg"><i class="la la-facebook"></i></a></li>
            <li class="mr-1"><a href="{{ $settings->twitter }}" class="twitter-bg"><i class="la la-twitter"></i></a></li>
      ...
      <div class="col-lg-3 responsive-column-half">
        <div class="footer-item">
          ...
          <ul class="generic-list-item">
            ...
            <li><a href="{{ route('instructor.become.register') }}">Become a Teacher</a></li>
      ...
      <div class="col-lg-3 responsive-column-half">
        <div class="footer-item">
          ...
          <div class="mobile-app">
            ...
            <a href="#" class="d-block mb-2 hover-s"><img src="{{ asset('application/public/templates/assets/images/appstore.png') }}" alt="App store" class="img-fluid"></a>
            <a href="#" class="d-block hover-s"><img src="{{ asset('application/public/templates/assets/images/googleplay.png') }}" alt="Google play store" class="img-fluid"></a>
          </div>
        </div><!-- end footer-item -->
      </div><!-- end col-lg-3 -->
    </div><!-- end row -->
  ...
  <div class="copyright-content py-4">
    <div class="container">
      <div class="row align-items-center">
        <div class="col-lg-6">
          <p class="copy-desc">{{ $settings->copyright }}</p>
        </div><!-- end col-lg-6 -->
        <div class="col-lg-6">
