            ...
            @foreach ($blog as $item)
                <div class="card card-item">
                    <div class="card-image">
                        <a href="{{ route('blog.details', ['slug' => $item->post_slug]) }}" class="d-block">
                    ...
                    <div class="card-body">
                        <h5 class="card-title"><a href="{{ route('blog.details', ['slug' => $item->post_slug]) }}">{{ Str::limit($item->post_title, 50, '...') }}</a></h5>
                        <ul
                        ...
                        <div class="d-flex justify-content-between align-items-center pt-3">
                            <a href="{{ route('blog.details', ['slug' => $item->post_slug]) }}" class="btn theme-btn theme-btn-sm theme-btn-white">Read More <i
