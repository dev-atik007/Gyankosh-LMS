...
<body>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-7">
                    ...
                    <div class="card card-item">
                        <div class="card-body">
                            <h3 class="card-title fs-22 pb-3">Direct Payment</h3>
                            <div class="divider"><span></span></div>
                ...
                <div class="col-lg-5">
                    <div class="card card-item">
                        <div class="card-body">
                            ...
                            <a href="{{ route('cart.page') }}" class="btn-text"><i class="la la-edit mr-1"></i>Edit</a>
                        </div><!-- end card-body -->
                    </div><!-- end card -->
                    <div class="card card-item">
                        <div class="card-body">
    ...
    <script type="text/javascript">
        ...
        var stripe = Stripe(
            'pk_test_51Nkm2fDwdCK0e6asbhxdd1aQsPfDbbQDxQoGDUPpdEJDTfKLL01sFC7kryVszsuZS7Nmtnt2YIjrgHHYpH3YWJjx00UcwhyGaU'
            );
