                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('register') }}" method="POST">
                            ...
                            <div class="input-box">
                                ...
                                <div class="form-group">
                                    <input class="form-control form--control" type="password" name="password" id="password" placeholder="Enter Password">
                            ...
                            <div class="input-box">
                                ...
                                <div class="form-group">
                                    <input class="form-control form--control" type="password" name="password_confirmation" id="password_confirmation" placeholder="Enter Confirm Password">
                                    <span class="la la-lock input-icon"></span>
