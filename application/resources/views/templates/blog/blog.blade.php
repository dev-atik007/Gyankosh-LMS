                        ...
                        <div class="col-lg-6">
                            <div class="card card-item">
                                <div class="card-image">
                                    <a href="{{ route('blog.details', ['slug' => $data->post_slug]) }}" class="d-block">
                                        <img class="card-img-top lazy" src="{{ asset($data->post_image) }}"
                                            data-src="images/img8.jpg" alt="Card image cap">
                                    </a>
                                    <div class="course-badge-labels">
                                        <div class="course-badge">{{ $data->created_at->format('M d Y') }}</div>
                                    </div>
                                </div><!-- end card-image -->
                                <div class="card-body">
                                    <h5 class="card-title"><a href="{{ route('blog.details', ['slug' => $data->post_slug]) }}">{{ Str::limit($data->post_title, 50, '...') }}</a></h5>
                                    <ul
                                    ...
                                    <div class="d-flex justify-content-between align-items-center pt-3">
                                        <a href="blog-single.html" class="btn theme-btn theme-btn-sm theme-btn-white">Read
                                            More <i class="la la-arrow-right icon ml-1"></i></a>
                        ...
                        <div class="card card-item">
                            <div class="card-body">
                                ...
                                <ul class="generic-list-item">
                                    ...
                                    <li>
                                      <a href="{{ route('blog.category.list', ['id' => Crypt::encrypt($cat->id), 'slug' => $cat->category_slug]) }}">
                                          {{ $cat->category }}
                                      </a>
                                  </li>
                            ...
                            <div class="card-body">
                                ...
                                @foreach ($post as $data)
                                    <div class="media media-card border-bottom border-bottom-gray pb-4 mb-4">
                                        <a href="{{ route('blog.details', ['slug' => $data->post_slug]) }}" class="media-img">
                                            <img class="mr-3" src="{{ asset($data->post_image) }}" alt="Related course image">
                                        </a>
                                        <div class="media-body">
                                            <h5 class="fs-15"><a href="{{ route('blog.details', ['slug' => $data->post_slug]) }}">{{ $data->post_title }}</a></h5>
