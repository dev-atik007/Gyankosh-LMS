...
@section('title')
{{ $cateTitle->category }} | Gyankosh Learning
@endsection
    <!-- ================================
        ...
        <div class="container">
            <div class="breadcrumb-content d-flex flex-wrap align-items-center justify-content-between">
                <div class="section-heading">
                    <h2 class="section__title text-white">{{ $cateTitle->category }}</h2>
                </div>
                <ul
                                ...
                                <div class="card card-item">
                                    ...
                                    <div class="card-body">
                                        <h5 class="card-title"><a
                                                href="{{ route('blog.details', ['slug' => $data->post_slug]) }}">{{ $data->post_title }}</a>
                                        </h5>
                                        <ul
                            ...
                            <div class="card-body">
                                ...
                                <ul class="generic-list-item">
                                    @foreach ($blogCat as $cat)
                                        <li>
                                            <a
                                                href="{{ route('blog.category.list', ['id' => Crypt::encrypt($cat->id), 'slug' => $cat->category_slug]) }}">
                                                {{ $cat->category }}
                                            </a>
                                        </li>
                                    @endforeach
                            ...
                            <div class="card-body">
                                ...
                                @foreach ($post as $data)
                                    <div class="media media-card border-bottom border-bottom-gray pb-4 mb-4">
                                        <a href="{{ route('blog.details', ['slug' => $data->post_slug]) }}"
                                            class="media-img">
                                            <img class="mr-3" src="{{ asset($data->post_image) }}"
