            ...
            <div class="col-xl-12 mx-auto">
                <div class="card">
                    <div class="card-body p-4">
                        ...
                        <form action="{{ route('admin.subCategory.store') }}" method="POST" id="myForm" enctype="multipart/form-data" class="row g-3">
                            @csrf
                            ...
                            <div class="md-6">
                                ...
                                <input type="text" name="subcategory" class="form-control" id="subName">
