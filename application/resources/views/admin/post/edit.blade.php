            ...
            <div class="col-xl-12 mx-auto">
                <div class="card">
                    <div class="card-body p-4">
                        ...
                        <form action="{{ route('admin.blog.post.update') }}" method="POST" id="myForm"
                                ...
                                <select class="form-select" id="single-select-field" data-placeholder="Choose one thing"
                                    ...
                                    @foreach ($category as $category)
                                        <option value="{{ $category->id }}"
                                            {{ $category->id == $post->blogcat_id ? 'selected' : '' }}>
                            ...
                            <div class="form-group col-md-12">
                                ...
                                <textarea name="description" class="form-control" id="summernote">{!! $post->description !!}</textarea>
