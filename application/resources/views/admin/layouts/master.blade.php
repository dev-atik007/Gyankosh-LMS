...
<head>
    ...
    <link rel="icon" href="{{ asset('application/public/backend/assets/images/favicon-32x32.png') }}"
        type="image/png" />
    <link href="{{ asset('application/public/backend/assets/plugins/vectormap/jquery-jvectormap-2.0.2.css') }}"
        rel="stylesheet" />
    <link href="{{ asset('application/public/backend/assets/plugins/simplebar/css/simplebar.css') }}"
        rel="stylesheet" />
    <link href="{{ asset('application/public/backend/assets/plugins/perfect-scrollbar/css/perfect-scrollbar.css') }}"
        rel="stylesheet" />
    <link href="{{ asset('application/public/backend/assets/plugins/metismenu/css/metisMenu.min.css') }}"
        rel="stylesheet" />
...
<body>
    ...
    @stack('script-lib')
    <script src="{{ asset('application/public/backend/assets/plugins/perfect-scrollbar/js/perfect-scrollbar.js') }}">
    </script>
    <script src="{{ asset('application/public/backend/assets/plugins/vectormap/jquery-jvectormap-2.0.2.min.js') }}">
    </script>
    <script src="{{ asset('application/public/backend/assets/plugins/vectormap/jquery-jvectormap-world-mill-en.js') }}">
    </script>
